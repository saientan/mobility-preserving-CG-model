...
def plots(location, feature_names):
    ...
    r2_train='%.3f' % r2_train
    #r2_train=round(r2_train,3)
    #mae_train=round(mae_train,3)
    mae_train='%.3f' % mae_train
...
#feature_names=[r"$D_{AA}$",r"$K^{B1}$",r"$r_{0}^{B1}$",r"$K^{B2}$",r"$r_{0}^{B2}$",r"$K^{A1}$",r"$\theta_{0}^{A1}$",r"$K^{A2}$",r"$\theta_{0}^{A2}$",r"$K^{A3}$",r"$\theta_{0}^{A3}$", r"$K1^{D1}$",r"$K2^{D1}$",r"$K3^{D1}$", r"$K1^{D2}$",r"$K2^{D2}$",r"$K3^{D2}$", r"$K1^{D3}$",r"$K2^{D3}$",r"$K3^{D3}$"]
...
fig.tight_layout()
axes[1,0].set_xlabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
axes[1,0].set_ylabel(r"Predicted $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
...
feature_names=[r"$D_{AA}$",r"$K^{B1}$",r"$r_{0}^{B1}$",r"K_B2",r"$r_{0}$_B2$",r"K_A1$)",r"$\theta_{0}$",r"K_A2",r"$\theta_{0}$_A2$",r"K_A3($kcalmol$)",r"$\theta_{0}$", r"K1_D1",r"K2_D1",r"K3_D1()", r"K1_D2()",r"K2_D2()",r"K3_D2()", r"K1_D3()",r"K2_D3()",r"K3_D3()"]
...
fig.tight_layout()
axes[0,1].set_xlabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
axes[0,1].set_ylabel(r"Predicted $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
...
axes[0,0].set_xlabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
axes[0,0].set_ylabel(r"Predicted $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
...
feature_names=[r"$D_{AA}$",r"$r_{0}^{B1}$",r"$r_{0}$_B2$",r"$\theta_{0}$",r"$\theta_{0}$"]


train_real,train_RFR,test_real,test_RFR, r2_train, mae_train, r2_test,mae_test=plot_new("../ML_with_important_features/5_input/")



axes[2,0].set_xlabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
axes[2,0].set_ylabel(r"Predicted $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
...
axes[2,0].set_title(r"$D_{AA}$+ 4 most imporant features", fontsize=20)

feature_names=[r"$D_{AA}$",r"$r_{0}^{B1}$"]
...
axes[2,1].set_xlabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
axes[2,1].set_ylabel(r"Actual $D_{CG}$ $(in$ $10^{-9} m^{2} s^{-1})$",fontsize=20)
...
axes[2,1].set_title(r"$D_{AA}$+ 1 most imporant features", fontsize=20)


axes[0,0].text(-4,32,"(a)", size=20)
axes[0,1].text(-4,32,"(b)", size=20)
axes[1,0].text(-4,32,"(c)", size=20)
axes[1,1].text(-0.05,20.5,"(d)", size=20)
