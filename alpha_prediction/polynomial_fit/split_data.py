...
for i in range(2,8):
    ...
    axes[row,column].set_xlabel(r"Actual $\alpha$",fontsize=20)
    axes[row,column].set_ylabel(r"Fitted $\alpha$",fontsize=20)
    axes[row,column].set_xlim(0,31)
    axes[row,column].set_ylim(0,31)
   # axes[row,column].text(-4,30,"(a)", size=20)
...
axes[0,0].text(-3,32,"(a)", size=20)
axes[0,1].text(-3,32,"(b)", size=20)
axes[1,0].text(-3,32,"(c)", size=20)
axes[1,1].text(-3,32,"(d)", size=20)
axes[2,0].text(-3,32,"(e)", size=20)
axes[2,1].text(-3,32,"(f)", size=20)
